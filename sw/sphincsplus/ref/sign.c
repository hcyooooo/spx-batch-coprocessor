...
{
    int spx_profile_started =
        SPX_PROFILE_PHASE_BEGIN(SPX_PROFILE_PHASE_KEYGEN);
    spx_ctx ctx;
    ...
    SPX_PROFILE_PHASE_END(SPX_PROFILE_PHASE_KEYGEN, spx_profile_started);
    return 0;
}
...
{
    int spx_profile_started =
        SPX_PROFILE_PHASE_BEGIN(SPX_PROFILE_PHASE_SIGN);
    spx_ctx ctx;
    ...
    *siglen = SPX_BYTES;
    ...
    SPX_PROFILE_PHASE_END(SPX_PROFILE_PHASE_SIGN, spx_profile_started);
    return 0;
}
...
{
    int spx_profile_started =
        SPX_PROFILE_PHASE_BEGIN(SPX_PROFILE_PHASE_VERIFY);
    spx_ctx ctx;
    ...
    if (siglen != SPX_BYTES) {
        SPX_PROFILE_PHASE_END(SPX_PROFILE_PHASE_VERIFY, spx_profile_started);
        return -1;
    }
